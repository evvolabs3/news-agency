import type { AnalysisResult, Article } from '../src/shared/types';
...
function pickTopics(text: string): string[] {
...
export function buildAnalysis(article: Article): AnalysisResult {
